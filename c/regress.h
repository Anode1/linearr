 ...
 * use the QR, which does not square the columns); -3 if the RESPONSE's sums
 * overflowed the same way -- there the QR is no remedy, because both solvers
 * square the response for its residual, and rescaling is the only cure.
 * Note what is
